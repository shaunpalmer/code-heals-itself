...
import { SelfHealingPipeline, PipelineExamples } from './pipeline-integration';
...
async function runDemo(): Promise<void> {
  ...
  try {
    ...
    console.log('\n✅ Test 1: Successful patch');
    const result1 = await pipeline.executePatch(
      'demo-patch-001',
      'typescript',
      'console.log("before");',
      'console.log("after");'
    ...
    try {
      ...
      const result2 = await pipeline.executePatch(
        'demo-patch-002',
        'typescript',
        'const valid = true;',
        'const invalid = }',
