...
class SeniorDeveloperSimulator {
  ...
  debugLikeHuman(error: string, context: Record<string, any>): Record<string, any> {
  ...
  private mapToStrategy(analysis: Record<string, any>): string {
  ...
  private generateDebugSteps(analysis: Record<string, any>): string[] {
...
export { HumanDebuggingHeuristic, PathAnalysisHeuristic, MentalSimulationHeuristic, SeniorDeveloperSimulator };