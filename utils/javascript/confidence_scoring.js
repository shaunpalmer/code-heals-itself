...
class UnifiedConfidenceScorer {
  ...
  calculate_confidence(logits, error_type, historical_data = null, taxonomyDifficulty = null) {
    /**
     ...
     * @param {number|null} taxonomyDifficulty - Optional difficulty score from taxonomy (0.0-1.0)
  ...
  _calculate_components(probabilities, error_type, historical_data, taxonomyDifficulty = null) {
    /** 
     * Calculate confidence components based on various factors 
     * 
     * @param {Array<number>} probabilities - Softmax probabilities
     * @param {string} error_type - Type of error being addressed
     * @param {Object} historical_data - Optional historical performance data
     * @param {number|null} taxonomyDifficulty - Optional difficulty score from taxonomy (0.0-1.0)
     */
